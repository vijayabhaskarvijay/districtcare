...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password === $confirmPassword) {
        ...
        try {
            ...
            $stmt = $conn->prepare("UPDATE ngo_details SET ngo_user_pwd = :password WHERE ngo_id = :ngoId");
            $stmt->bindParam(':password', $password);
            $stmt->bindParam(':ngoId', $ngoId);
            $stmt->execute();
...
<head>
    ...
    <title>NGO Reset Password</title>
    <style>
        body {
