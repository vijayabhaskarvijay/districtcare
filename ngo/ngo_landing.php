        ...
        <div class="s-layout__sidebar">
            ...
            <nav class="s-sidebar__nav">
                <ul>
                    ...
                    <li>
                        <a class="s-sidebar__nav-link" href="ngo_prof_manage.php">
                            <i class="fa fa-user"></i><em> Profile</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="ngo_post_creation.php">
                            <i class="fa-solid fa-plus"></i><em>Create Post</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="ngo_post_manage.php?ngo_id=<?php echo $_SESSION['ngo_id']; ?>&ngo_username=<?php echo $_SESSION['ngo_username']; ?>">
                            <i class="fa fa-camera"></i><em>Manage Post</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="ngo_probpage.php">
                            <i class="fa-solid fa-users"></i><em>See Reported Problems</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="ngo_fund_manage.php">
