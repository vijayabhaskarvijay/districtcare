        ...
        <div class="s-layout__sidebar">
            ...
            <nav class="s-sidebar__nav">
                <ul>
                    ...
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_prof_manage.php">
                            <i class="fa fa-user"></i><em> Profile</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_post_creation.php">
                            <i class="fa-solid fa-plus"></i><em>Create Post</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_manage_post.php">
                            <i class="fa fa-camera"></i><em>Manage Post</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_manageall_post.php">
                            <i class="fa fa-camera"></i><em>Manage All Side Post</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_manage_userreports.php">
                            <i class="fa-solid fa-user-secret"></i><em>User Report Manage</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_user_management.php">
                            <i class="fa-solid fa-people-arrows"></i><em>Manage Users</em>
                            <!-- <i class="fa-solid fa-people-arrows fa-bounce"></i><em>Manage Users</em> -->
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_ngo_manage.php">
                            <i class="fa-solid fa-building-ngo"></i><em>Manage Ngo</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_govn_manage.php">
                            <i class="fa-solid fa-handshake-angle"></i><em>Manage Govn Staff</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_register_govn.php">
                            <i class="fa-solid fa-book-open-reader"></i><em>Register Govn Staff</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="ngo_acc_req.php">
                            <i class="fa fa-address-card-o" aria-hidden="true"></i><em>NGO Account Request</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="admin_public_help.php">
                            <i class="fa-solid fa-heading" aria-hidden="true"></i><em>Reply Questions</em>
                        </a>
                    </li>
