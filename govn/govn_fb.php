...
<body>
    ...
    if (isset($_GET['prob_id'])) {
        ...
        $feedback_sql = "SELECT * FROM feedback_details WHERE fb_prob_id = ?";
        ...
        if ($feedback_result->num_rows > 0) {
            ...
            $_SESSION['fb_id'] = $feedback_data['fb_id'];
            $_SESSION['fb_prob_id'] = $feedback_data['fb_prob_id'];
            $_SESSION['fb_user_name'] = $feedback_data['fb_user_name'];
            $_SESSION['fb_prob_dept'] = $feedback_data['fb_prob_dept'];
            $_SESSION['fb_prob_type'] = $feedback_data['fb_prob_type'];
            $_SESSION['fb_prob_desc'] = $feedback_data['fb_prob_desc'];
            $_SESSION['fb_prob_loc'] = $feedback_data['fb_prob_loc'];
            $_SESSION['fb_prob_date'] = $feedback_data['fb_prob_date'];
            $_SESSION['fb_desc'] = $feedback_data['fb_desc'];
            $_SESSION['fb_rate'] = $feedback_data['fb_rate'];
    ...
    <div class="container">
        ...
        <div class="fb-in">
            <label>Problem Department:</label>
            <p><?php echo $_SESSION['fb_prob_dept']; ?></p>
        </div>
