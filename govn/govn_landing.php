...
// Check if logged in
if (!isset($_SESSION['sv_gvn_staffname'])) {
    // Redirect to login page
    header("Location:govn_login.php");
    exit();
}

if (isset($_SESSION['sv_gvn_staffphone'])) {
    $gvnld_staffPhone = $_SESSION['sv_gvn_staffphone'];
} else {
    // Handle case when user_phone is not set in the session
    $gvnld_staffPhone = "N/A";
}

//STORE THE SESSION VARIABLES
$gvnld_staffID = $_SESSION['sv_gvn_staffid'];
$gvnld_staffUsername = $_SESSION['sv_gvn_staffname'];
$gvnld_staffEmail = $_SESSION['sv_gvn_staffemail'];
$gvnld_staffPhone = $_SESSION['sv_gvn_staffphone'];
$gvnld_staffloc =  $_SESSION['sv_gvn_staffloc'];
$gvnld_staffDept = $_SESSION['sv_gvn_staffdept'];
...
<head>
    <title>Govn Staff Landing</title>
    <link rel="icon" href="../images/urbanlink-logo.png" type="image/icon type">
    <link rel="stylesheet" href="govn_landing_style.css">
...
<body>
        ...
        <div class="s-layout__sidebar">
            ...
            <nav class="s-sidebar__nav">
                <ul>
                    ...
                    <li>
                        <a class="s-sidebar__nav-link" href="govn_profile_manage.php">
                            <i class="fa fa-user"></i><em> Profile</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="govn_post_creation.php">
                            <i class="fa-solid fa-plus"></i><em>Create Post</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="govn_manage_post.php">
                            <i class="fa fa-camera"></i><em>Manage Post</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="govn_probpage.php">
                            <i class="fa-solid fa-users"></i><em>See Reported Problems</em>
                        </a>
                    </li>
                    <hr class="hr-1">
                    <li>
                        <a class="s-sidebar__nav-link" href="govn_fund_manage.php">
                            <i class="fa-solid fa-delete-left"></i><em>See Requested Funds</em>
                        </a>
                    </li>
    ...
    <script>
        ...
        var isLoading = false; // Track if posts are being loaded
        ...
        function loadMorePosts() {
            ...
            // Fetch new posts from the server using AJAX or Fetch API
            fetch(`load_more_posts.php?page=${page}`)
                ...
                .then(posts => {
                    ...
                    posts.forEach(post => {
                        // Create new post element and add content
                        var newPost = document.createElement('div');
                        newPost.className = 'post';
                        // Set the content of the new post element
        ...
        // Optional: Add a button click event to load more posts manually
